...
def save():
    ...
    if N1=="" or C1=="Select Class" or D2=="" or Re1=="" or S1=="" or fathername=="" or mothername=="" or F1=="" or M1=="":
        messagebox.showerror("Error","Few Data is is missing!")
    else:
        file=openpyxl.load_workbook('Student_data.xlsx')
        sheet=file.active
...
##top frames
Label(root,text="Email: zeyadofortech@gmail.com",width=10,height=3,bg="#f0687c",anchor='e').pack(side=TOP,fill=X)
...
#parents details
obj2=LabelFrame(root,text="Parents' Details",font=20,bd=2,width=900,bg=framebg,fg=framefg,height=220,relief=GROOVE)
...
f_ent=Entry(obj2,textvariable=F_Occupation,width=20,font="arial 10")
f_ent.place(x=160,y=100)
...
M_ent=Entry(obj2,textvariable=M_Occupation,width=20,font="arial 10")
M_ent.place(x=630,y=100)
...
resetButton=Button(root,text="Reset",width=19,height=2,font="arial 12 bold",bg="lightpink",command=Clear)
resetButton.place(x=1000,y=530)
exitButton=Button(root,text="Exit",width=19,height=2,font="arial 12 bold",bg="grey",command=Exit)
